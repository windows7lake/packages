...
class WebViewHostApi {
  ...
  Future<void> setScrollListener(int arg_instanceId, int? arg_listenerInstanceId) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
...
class WebSettingsHostApi {
  ...
  Future<void> setMixedContentModeEnable(int arg_instanceId, bool arg_enabled) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.WebSettingsHostApi.setMixedContentModeEnable', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_instanceId, arg_enabled]) as List<Object?>?;
    if (replyList == null) {
...
class ScrollListenerHostApi {
  /// Constructor for [ScrollListenerHostApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  ScrollListenerHostApi({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  final BinaryMessenger? _binaryMessenger;
...
abstract class ScrollListenerFlutterApi {
  ...
  static void setup(ScrollListenerFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.ScrollListenerFlutterApi.onScrollOffsetChange', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ScrollListenerFlutterApi.onScrollOffsetChange was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.ScrollListenerFlutterApi.onScrollOffsetChange was null, expected non-null int.');
          final double? arg_offset = (args[1] as double?);
          assert(arg_offset != null,
              'Argument for dev.flutter.pigeon.ScrollListenerFlutterApi.onScrollOffsetChange was null, expected non-null double.');
          api.onScrollOffsetChange(arg_instanceId!, arg_offset!);
          return;
        });
      }
    }
...
abstract class WebChromeClientFlutterApi {
  ...
  static void setup(WebChromeClientFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.WebChromeClientFlutterApi.onTitleChange', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.onTitleChange was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.onTitleChange was null, expected non-null int.');
          final int? arg_webViewInstanceId = (args[1] as int?);
          assert(arg_webViewInstanceId != null,
              'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.onTitleChange was null, expected non-null int.');
          final String? arg_title = (args[2] as String?);
          assert(arg_title != null,
              'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.onTitleChange was null, expected non-null String.');
