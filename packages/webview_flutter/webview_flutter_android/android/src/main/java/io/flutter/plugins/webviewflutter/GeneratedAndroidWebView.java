...
public class GeneratedAndroidWebView {
  ...
  public interface WebViewHostApi {
    ...
    void setScrollListener(@NonNull Long instanceId, @Nullable Long listenerInstanceId);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                Number listenerInstanceIdArg = (Number) args.get(1);
                try {
                  api.setScrollListener((instanceIdArg == null) ? null : instanceIdArg.longValue(), (listenerInstanceIdArg == null) ? null : listenerInstanceIdArg.longValue());
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
  ...
  public interface WebSettingsHostApi {
    ...
    void setMixedContentModeEnable(@NonNull Long instanceId, @NonNull Boolean enabled);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebSettingsHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.WebSettingsHostApi.setMixedContentModeEnable", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Boolean enabledArg = (Boolean) args.get(1);
                try {
                  api.setMixedContentModeEnable((instanceIdArg == null) ? null : instanceIdArg.longValue(), enabledArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
  ...
  public interface ScrollListenerHostApi {
    ...
    /**Sets up an instance of `ScrollListenerHostApi` to handle messages through the `binaryMessenger`. */
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable ScrollListenerHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
  ...
  public static class ScrollListenerFlutterApi {
    ...
    public ScrollListenerFlutterApi(@NonNull BinaryMessenger argBinaryMessenger) {
      this.binaryMessenger = argBinaryMessenger;
    }
    ...
    public void onScrollOffsetChange(@NonNull Long instanceIdArg, @NonNull Double offsetArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.ScrollListenerFlutterApi.onScrollOffsetChange", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(instanceIdArg, offsetArg)),
          channelReply -> callback.reply(null));
    }
  }
  /** Generated interface from Pigeon that represents a handler of messages from Flutter. */
  ...
  public static class WebChromeClientFlutterApi {
    ...
    public void onTitleChange(@NonNull Long instanceIdArg, @NonNull Long webViewInstanceIdArg, @NonNull String titleArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.WebChromeClientFlutterApi.onTitleChange", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, titleArg)),
          channelReply -> callback.reply(null));
    }
