    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          final int? arg_listenerInstanceId = (args[1] as int?);
          api.setScrollListener(arg_instanceId!, arg_listenerInstanceId);
          return <Object?>[];
        });
      }
    }
  ...
  static void setup(TestWebSettingsHostApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.WebSettingsHostApi.setMixedContentModeEnable was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.WebSettingsHostApi.setMixedContentModeEnable was null, expected non-null int.');
          final bool? arg_enabled = (args[1] as bool?);
          assert(arg_enabled != null,
              'Argument for dev.flutter.pigeon.WebSettingsHostApi.setMixedContentModeEnable was null, expected non-null bool.');
...
abstract class TestScrollListenerHostApi {
  ...
  static void setup(TestScrollListenerHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
